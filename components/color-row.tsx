  ...
  return (
    <div className="group/row">
      <div className="flex items-start gap-2 sm:gap-4">
        <div className="w-14 sm:w-20 shrink-0 pt-2 sm:pt-4 lg:pt-5">
          <span className="text-xs sm:text-sm font-medium text-foreground capitalize leading-tight">{group.name}</span>
          {group.isNew && (
